                ...
                <div class="modal-body row" style="height:550px;">
                    ...
                    {else}
                        ...
                        {else if $IMAGE_FILE_TYPE eq 'yes'}
                            <div style="overflow:auto;height:100%;width:100%;float:left;background-image: url('{$DOWNLOAD_URL|escape:'html'}');background-color: #EEEEEE;background-position: center 25%;background-repeat: no-repeat;display: block; background-size: contain;"></div>
